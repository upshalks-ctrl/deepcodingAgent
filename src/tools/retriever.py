...
class RetrieverTool(BaseTool):
    ...
    description: str = "Useful for retrieving information from the file with `rag://` uri prefix, it should be higher priority than the web search. Input should be a search keywords."
