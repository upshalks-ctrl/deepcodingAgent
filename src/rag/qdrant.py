...
class QdrantRetriever(Retriever):
    ...
    def _load_example_files(self, user_id: str, conversation_id: str) -> None:
    ...
    def _insert_document_chunk(
        self, doc_id: str, content: str, title: str, url: str, user_id: str, conversation_id: str, metadata: Dict[str, Any], generated_questions: List[str]
    ) -> None:
    ...
    def query_relevant_documents(
            ...
            for resource in resources:
                if resource.doc_id:
                    should_conditions.append(
                        FieldCondition(key="doc_id", match=MatchValue(value=resource.doc_id))
                    )
        ...
        search_results = self.client.query_points(
            ...
            limit=self.top_k,
            with_payload=True,
            query_filter=qdrant_filter,  # 传入 Filter
        ).points
        ...
        for result in search_results:
            ...
            full_content.append(f"doc_id: {doc_id}\n\n content: {content}\n\n")
    ...
    def load_examples(self, force_reload: bool = False, user_id: str = "", conversation_id: str = "") -> None:
        if not self.client:
            self._connect()
        ...
        self._load_example_files(user_id, conversation_id)
